...
<br>
    ...
    <table style="margin-top: 10px" class="table">
        ...
        <tbody id="mainTable">
        <c:forEach var="player" items="${playerList}" varStatus="i">
            <tr>
                <td>${player.id}</td>
                <td>${player.name}</td>
                <td>${player.title}</td>
                ...
                <td>${player.level}</td>
                <td>${player.untilNextLevel}</td>
                <td>${player.birthday}</td>
                <td>${player.banned}</td>
                <td><a href="/rest/players/${player.id}">редактировать</a></td>
                <td><a data-method="delete" href="/rest/players/${player.id}">удалить</a></td>
                <td><form:form method="DELETE" action="/rest/players/${player.id}" >
    ...
    <form style="background-color: #E9ECEF; padding: 20px; border-radius: 10px; display: none" id="createButton">
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputNameNew"></label>
                <input type="text" class="form-control" id="inputNameNew" placeholder=${player.name}>
            </div>
            <div class="form-group col-md-6">
                <label for="inputTitleNew">Title</label>
                <input type="text" class="form-control" id="inputTitleNew" placeholder=${player.title}>
            </div>
        </div>
        <div class="form-row">
